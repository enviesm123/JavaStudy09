...
public class StringMain {
    public static void main(String[] args) {
        ...
        // .contains는 괄호 안 문자열을 포함하면 true, 포함하지않으면 false
...
//        System.out.println(nullthing.length()); //에러발생
        ...
        System.out.println(fruits.indexOf(","));
        System.out.println(fruits);
