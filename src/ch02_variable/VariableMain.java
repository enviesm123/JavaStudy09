...
//        System.out.println(myMoney);
        ...
        // 변수에 값 할당
        // 변수에 값을 할당하는 작업에 대해
        // 변수 초기화(Initialization - Init)
        // 등호 (=)를 이용하며 변수에 값을 담을 수 있다.
        // 등호 오른쪽의 값을 왼쪽에 담는 기능 수행
        myMoney = 10000;
        System.out.println(myMoney);

        // 변수의 값 변경 (값을 변경 할 수 있으므로 변수라고 부름)
        myMoney = 100000;
        System.out.println(myMoney);
        ...
        // long 타입으로 인식함
        long longNum = 17283971939827398L;

        //소수 타입
        // 그냥 소수 3.141592 를 입력하게 되면 double 타입으로 인식
        float pi = 3.141592f; // 뒤에 f를 붙여 주어야 float으로 인식

        double doubleNum = 100.12314;
...
//        MATH_PI = 4.1;
        ...
        byteNumber++; //바이트가 -128 부터 127까지 담을 수 있어서 -128이 나옴
