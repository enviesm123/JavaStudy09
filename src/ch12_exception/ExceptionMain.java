...
public class ExceptionMain {
    ...
    public static void main(String[] args){
        ...
        try{
            ...
            // 출력되는 시점이 다르다.
            System.out.println("빨간 글씨 아래");
            System.err.println("빨간 글씨 출력");
            System.out.println("검정 글씨");
            // 스프링 프레임워크 (자바가 서버 벡단을 맡음)
...
//        }
        ...
        // throws를 하지않고 try - catch를 해준다
        try {
            long time = ExMethod.dateToMillSec("2023");
        ...
        try {
            ...
            System.out.println("0~2 하나의 숫자 입력");
        }
        ...
        try{
            ...
            System.out.println("이건 원인을 모르겠는데..");
        }
